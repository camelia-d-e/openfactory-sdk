...
VALUES 
('12', NULL, @Type, @Mfr, @Model, 'room-001', 'DustTrak Environmental Monitor', 'DustTrak_Prefab', '8543210412', '2025-08-01');
...
VALUES ('pm1_concentration', @TypeConcentration, '12');
...
INSERT INTO Variable (Nom, TypeId, EquipmentId)
VALUES ('pm2_5_concentration', @TypeConcentration, '12');
...
INSERT INTO Variable (Nom, TypeId, EquipmentId)
VALUES ('pm4_concentration', @TypeConcentration, '12');
...
INSERT INTO Variable (Nom, TypeId, EquipmentId)
VALUES ('pm10_concentration', @TypeConcentration, '12');
...
INSERT INTO Variable (Nom, TypeId, EquipmentId)
VALUES ('PositionX', @TypePosition, '12');
...
INSERT INTO Variable (Nom, TypeId, EquipmentId)
VALUES ('PositionY', @TypePosition, '12');
...
INSERT INTO Variable (Nom, TypeId, EquipmentId)
VALUES ('PositionZ', @TypePosition, '12');
